...
export default class Header extends Component {
  ...
  addRepository = async () => {
    let repositories = (await JSON.parse(AsyncStorage.getItem('@Github:repositories'))) || [];
    repositories = { ...repositories, this.state.repository };
    await AsyncStorage.setItem(JSON.stringify(repositories));
  };
