...
export default class Header extends Component {
  ...
  createRespository = (repository) => {
    return {
      ...
      organization: repository.organization ? repository.organization.login : repository.owner.login,
      avatar: repository.organization ? repository.organization.avatar_url : repository.owner.avatar_url,
